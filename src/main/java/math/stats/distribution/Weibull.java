...
public class Weibull extends AbstractContinuousDistribution {
    ...
    public double pdf(double x) {
        ...
        double xscalepow = FastMath.pow(xscale, shape_k - 1);
        double xscalepowshape = xscalepow * xscale;
        return shape_dividedby_scale * xscalepow * FastMath.exp(-xscalepowshape);
    }
    ...
    public double inverse(double probability) {
        ...
        return scale_lambda * FastMath.pow(-FastMath.log1p(-probability), inverse_shape);
    }
